...
public class AuthRequest {
	...
	public String getRequest(int format) throws XMLStreamException, Exception {
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
                
                XMLOutputFactory factory = new ConfluenceXmlOutputFactory(ContextClassLoaderSwitchingUtil.runInContext(this.getClass().getClassLoader(), new Callable<XMLOutputFactory>()
            {
                @Override
